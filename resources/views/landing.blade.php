...
<body>
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            <h1>Selamat Datang di Sistem Pakar Tindak Pidana Kecelakaan Lalu Lintas</h1>
            <h2>Kami Siap Membantu Mengidentifikasi Tindak Pidana Kecelakan Lalu Lintas</h2>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 d-flex align-items-stretch">
                        <div class="content">
                            <h3>Mengapa Harus Menggunakan Sistem Ini</h3>
                            <p>
                                Dengan meggunakan sistem ini pengguna akan lebih mudah untuk mengidentifikasi pelaku
                                pidana kecelakaan lalu lintas terjerat pasal berapa dengan mempertimbangkan tingkat
                                kepercayaan dari seorang pakar yang berprofesi sebagai hakim
                            </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0 mb-3">
                                        ...
                                        <h4>Membantu Profesi Penegak Hukum</h4>
                                        <p>Bertujuan untuk membantu para penegak hukum dalam mengatasi tantangan
                                            maraknya pidana kecelakaan lalu lintas</p>
                                    </div>
                                </div>
                                <div class="col-xl-4 d-flex align-items-stretch">
                                    <div class="icon-box mt-4 mt-xl-0 mb-3">
                                        <i class="mb-3 bi bi-person-check"></i>
                                        <h4>Berdasarkan Pengalaman Pakar</h4>
                                        <p>Representasi pengetahuan data dibangun berdasarkan observasi dan validasi
                                            melalui pakar</p>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="about" class="doctors">
            <div class="container">
                ...
                <div class="section-title">
                    <h2>About Us</h2>
                    <p>Profile Sistem Pakar Tindak Pidana Kecelakaan Lalu Lintas</p>
                </div>

                <div class="row justify-content-center">
                    <div class="col-lg-6 mx-auto">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="landing/img/team2.png" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Website Sistem Pakar Tindak Pidana Kecelakan Lalu Lintas</h4>
                                <span>Website ini digunakan untuk mendukung para aparatur penegak hukum agar mudah
                                    mengidentifikasi dasar hukum untuk pelaku tindak pidana kecelakaan lalu
                                    lintas</span>
                                <div class="social">
