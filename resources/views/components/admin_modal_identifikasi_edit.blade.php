          ...
          <form id="edit-identifikasi" action="" method="post">
            ...
            <div class="input-form d-flex">
                ...
                <div class="form-floating mb-3 p-2 mx-2">
                    <input type="text" class="form-control" id="kode-identifikasi" placeholder="kode identifikasi" name="kode_identifikasi" readonly>
                    <label for="kode-identifikasi">Kode Identifikasi</label>
                </div>
                <div class="form-floating mb-3 p-2 mx-2">
                    <input type="text" class="form-control" id="identifikasi" placeholder="identifikasi" name="identifikasi">
        ...
        <div class="modal-body">
          ...
          <form id="tambah-identifikasi" action="{{ route('identifikasi.store') }}" method="post">
            ...
            <div class="input-form d-flex">
                <input type="hidden" name="id" id="id_identifikasi">
                <div class="form-floating mb-3 p-2 mx-2">
                    <input type="text" class="form-control" id="kode-identifikasi" name="kode_identifikasi" required>
