...
<head>
    ...
    <link media="all"
        href="pasal-assets/wp-content/cache/autoptimize/css/autoptimize_7a1ecf2654b585c47ef39ad343596e82.css"
        rel="stylesheet" />
    <link media="print"
    ...
    <script>
        (function($) {
            ...
            $(document).on('click', '.language-toggle', function() {
                ...
                } else if (FWP.facets.language === undefined || FWP.facets.language.length == 0 || FWP
                    .facets.language[0] == '0') {
            ...
            $(document).on('facetwp-loaded', function() {
                ...
                if ('undefined' !== typeof FWP.facets['sort_by']) {
                    $('.sort-order-button').filter('[data-value="' + FWP.facets['sort_by'] + '"]').addClass(
                        "checked");
                    let current_sort = $('.sort-order-button').filter('[data-value="' + FWP.facets[
                        'sort_by'] + '"]').text();
    ...
    <div id="page" class="site">
        <header id="header" class="clearfix">
            <div class="wrap normal"> <a id="logo" href="/"><img
                        src="pasal-assets/wp-content/themes/mha_s2s/assets/images/logo.png"
                        alt="Logo Sistem Pakar" /></a>
                    ...
                    <div class="menu-main-menu-container">
                        <ul id="main-menu" class="sf-menu">
                            ...
                            <li>
                                <i>
                                    @auth
                                        <p class="mt-3" id="welcome-message"
                                            style="cursor: pointer; color: #009244; font-size: 14px;">Selamat datang,
            ...
            <article id="post-22" class="post-22 screen type-screen status-publish hentry condition-depression">
                <div class="wrap normal">
                    <div class="page-heading plain">
                        <h2 style="color: #2c6440" class="entry-title">
                            <center>Identifikasi Pelanggaran Tindak Pidana Kecelakaan Lalu Lintas</center>
                        </h2>
                    </div>
                </div>
                                                    ...
                                                    <li id="field_{{ $loop->iteration }}"
                                                        ...
                                                        <div class='ginput_container ginput_container_radio'>
                                                            <ul class='gfield_radio'
                                                                ...
                                                                @endforeach
                                                                <input type="hidden"
                                                                    name="kondisi[{{ $item->kode_identifikasi }}]"
                                                                    id="kondisi_{{ $item->kode_identifikasi }}{{ $loop->iteration }}"
                                                                    value="" />
                                                            </ul>
                                                        </div>
                                                    </li>
