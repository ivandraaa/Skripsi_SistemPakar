    ...
    <main>
                            ...
                            <div class="row">
                                <div class="col-md-12 full-height mob-height mx-3">
                                    ...
                                    <div class="hero-center-wrap z-bigger">
                                        <h1 class="parallax-fade-top-2 typed">Cek Kesehatan <strong>Tanaman Brokoli
                                                Anda</strong>
                                            <br><span id="typed-1"></span>
                                        </h1>
                                    </div>
                                    <p class="hero-top-text">Pasalmu</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container text-left">
                            <div class="row">
                                <div class="col-md-12 full-height mob-height mx-3">
                                    ...
                                    <div class="hero-center-wrap z-bigger">
                                        <h1 class="parallax-fade-top">Atasi <br><span>Pasalmu</span></h1>
                                    </div>
            ...
            <div class="grid">
                ...
                <a class="grid__item" href="#preview-2">
                    <div class="box">
                        ...
                        <h3 class="box__title box__title--straight box__title--bottom"><span class="box__title-inner"
                                data-hover="diploma">diploma</span></h3>
                        <h4 class="box__text box__text--bottom"><span
                                class="box__text-inner box__text-inner--rotated1">gray</span></h4>
                    </div>
                </a>
                ...
                <a class="grid__item" href="#preview-4">
                    <div class="box">
                        ...
                        <h4 class="box__text box__text--bottom box__text--right"><span
                                class="box__text-inner box__text-inner--rotated3">milk</span></h4>
                    </div>
                </a>
                ...
                <a class="grid__item" href="#preview-6">
                    <div class="box">
                        ...
                        <h3 class="box__title"><span class="box__title-inner" data-hover="booklet">booklet</span>
                        </h3>
                ...
                <a class="grid__item" href="#preview-7">
                    <div class="box">
                        ...
                        <h3 class="box__title box__title--straight box__title--bottom"><span class="box__title-inner"
                                data-hover="a bottle">a bottle</span></h3>
        ...
        <div class="overlay">
            ...
            <div class="overlay__item" id="preview-1">
                ...
                <p class="overlay__content">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.
                </p>
            </div>
            <div class="overlay__item" id="preview-2">
                <div class="box">
                    ...
                    <h3 class="box__title box__title--straight box__title--bottom"><span
                            class="box__title-inner">diploma</span></h3>
                    <h4 class="box__text box__text--bottom"><span
                            class="box__text-inner box__text-inner--rotated1">gray</span></h4>
                </div>
                <p class="overlay__content">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.
            ...
            <div class="overlay__item" id="preview-7">
                <div class="box">
                    ...
                    <h3 class="box__title box__title--straight box__title--bottom"><span class="box__title-inner">a
                            bottle</span></h3>
                    <h4 class="box__text box__text--topcloser"><span class="box__text-inner">plant</span></h4>
                </div>
                <p class="overlay__content">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.
