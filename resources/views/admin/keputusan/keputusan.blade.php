                ...
                <table id="tabel-identifikasi" class="table table-bordered table-hover my-2">
                    <thead>
                        <tr>
                            ...
                            <th scope="col"><center>MB</center></th>
                            <th scope="col"><center>MD</center></th>
                            ...
                            <th scope="row">{{ $loop->iteration + $keputusan->firstItem() - 1 }}</th>
                                ...
                                <td>
                                    <button class="btn btn-outline-info" data-bs-toggle="modal"
                                        ...
                                        onclick="updateInput('{{ $item->id }}', '{{ $item->kode_identifikasi }}', '{{ $item->kode_pasal }}', '{{ $item->mb }}', '{{ $item->md }}'), actionUbahIdentifikasi('/keputusan/{{ $item->id }}')">
